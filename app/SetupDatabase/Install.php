...
class Install
{
    ...
    public function addCustomFields()
    {
        ...
        $customField->add([
            ...
            'type'        => 'profile',
            'field_type'  => 'textarea',
            'description' => '¿Cuáles son tus músicas favoritas, las separas con una coma (,)',
        ]);
        $customField->add([
            'name'        => 'Peliculas favoritas',
            'type'        => 'profile',
            'field_type'  => 'textarea',
            'description' => 'Cuáles son tus peliculas favoritas, las separas con una coma (,)',
        ]);

        $customField->add([
            'name'        => 'Citas favoritas',
            'type'        => 'profile',
            'field_type'  => 'textarea',
            'description' => 'Cuáles son tus citas favoritas',
        ]);
        ...
        $customField->add([
            ...
            'type'        => 'profile',
            'field_type'  => 'textarea',
            'description' => '¿Cuáles son tus habilidades personales?',
        ]);

        $customField->add([
            'name'        => 'Puntos de vista religiosos',
            'type'        => 'profile',
            'field_type'  => 'selection',
            'description' => 'Cual es tu religion',
            'options'     => [
                'Muslim',
                'Christian',
                'All',
        ...
        $customField->add([
            ...
            'type'        => 'profile',
            'field_type'  => 'selection',
            'description' => 'Cuál es tu interés',
            'options'     => [
                 'Hombres',
                 'Mujer',
                 'Mujeres y hombres',
    ...
    public function addHelps()
    {
        ...
        $helpRepository->add([
            'title'   => 'Cómo hacer conexiones',
            'content' => '¿Cómo se puede hacer las conexiones es muy fácil seguir o si usted sabe la persona solicitud de solicitud de amigo.',
        ]);

        $helpRepository->add([
            'title'   => 'Cómo publicar',
            'content' => '
            Puede publicar en sus conexiones a través de nuestro editor de publicaciones. Con él puedes compartir imágenes, vídeos, ubicación, e.t.c.
             También si estás con uno de tus amigos puedes publicar con ellos.

            ',
        ]);

        $helpRepository->add([
            'title'   => 'Cómo diseñar su perfil',
            'content' => '
               Siguiendo este proceso para diseñar tu perfil
                 1. Vaya a la configuración de su cuenta
                 2. En el menú derecho, haga clic en diseñar su enlace de página
                 3. Desde allí siga otras instrucciones para completar el deisng de su página
            ',
        ]);
    }
    ...
    public function addPagesCategories()
    {
        ...
        $category->add([
            'title' => 'Marca o Producto',
        ]);
        $category->add([
            'title' => 'compañía, organización o institución',
        ]);

        $category->add([
            'title' => 'Artista, Figura pública',
        ]);
